...
class AADSSOMercer
{
    ...
    public static function print_aad()
    {
        ...
        $html .= '<span class="aad__cta-text">Log In</span>';
        ...
        $html .= '<span class="aad__cta-text">Log Out</span>';
        ...
        $html .= '<a class="scroll__icon-wrapper" href="#standard-login">';
